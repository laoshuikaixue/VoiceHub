...
export default defineEventHandler(async event => {
  ...
  const values = {
    ...
    productNameSuffix: typeof body.productNameSuffix === 'string' ? body.productNameSuffix.slice(0, 30) : current.productNameSuffix,
    ...
    rechargeFeeRate: Number.isFinite(Number(body.rechargeFeeRate)) ? String(Math.max(0, Number(body.rechargeFeeRate))) : current.rechargeFeeRate,
