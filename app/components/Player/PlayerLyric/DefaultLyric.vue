  ...
  >
    <div class="lyric-content">
      <Transition name="fade" mode="out-in">
        ...
        <div v-else-if="!currentLyricData || currentLyricData.length === 0" class="lyric-loading">暂无歌词</div>
        <div
          v-else
...
const isYrcMode = computed(() => {
    ...
    return settings.showYrc.value && (format === 'qrc' || format === 'word-by-word' || format === 'enhanced');
});
