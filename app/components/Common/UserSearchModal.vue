          ...
          <div class="flex-1 overflow-y-auto p-8 pt-4 custom-scrollbar">
            ...
            <div class="relative mb-6 group">
              <div class="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                <Icon name="search" :size="20" class="text-zinc-500 group-focus-within:text-zinc-300 transition-colors" />
              </div>
              <input
                  ref="searchInput"
                  v-model="searchQuery"
            ...
            <div class="user-list space-y-3 min-h-[300px]">
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="text-[10px] font-black uppercase tracking-widest flex flex-wrap gap-2 mt-0.5 text-zinc-500">
