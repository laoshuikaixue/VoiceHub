...
const { checkImportantNotification, resetImportantNotification } = useImportantNotification()
...
watch(
  ...
  async ([authenticated, userId, requirePasswordChange, currentPath]) => {
    ...
    if (requirePasswordChange === true && currentPath === '/change-password') {
      resetImportantNotification()
      return
    }
