export const siteConfig = {
  ...
  legacyCardConversionEnabled: 'Convert Legacy Cards',
  legacyCardConversionEnabledDesc: 'Allow unused legacy request cards to convert into permanent quota',
  ...
  songs: {
    ...
    requestForm: {
      ...
      notifications: {
        ...
        cardCodeRedeemed: (amount: number) => `Request card redeemed: ${amount} permanent quota added`
      },
    ...
    songQuotaDisplay: {
      ...
      cardCodeBypassesLimit: 'Request card does not use quota'
    }
  }
} as const
...
export const serverErrors = {
  ...
  CARD_CODE_RATE_LIMITED: 'Too many request card validation attempts. Try again in {0}.',
  ...
  SONG_QUOTA_LEGACY_CARD_UNAVAILABLE: 'This legacy request card cannot be converted',
