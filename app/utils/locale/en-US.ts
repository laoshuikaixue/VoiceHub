...
export const payment = {
  title: 'Buy Song Cards',
  orders: 'My Orders',
  cards: 'Purchased Cards',
  disabled: 'Payments are disabled',
  ...
  refundReasonPlaceholder: 'Tell us why you need a refund',
  confirmRefund: 'Submit refund request',
  orderCreated: 'Order created',
  paymentHint: 'Cards are issued automatically after payment.',
  admin: {
    settings: 'Payment settings', providers: 'Payment providers', plans: 'Song card plans', orders: 'Payment orders', dashboard: 'Payment overview',
    save: 'Save', add: 'Add', enabled: 'Enable payments', providerKey: 'Provider', providerName: 'Name', config: 'Config JSON', supportedMethods: 'Methods'
  }
} as const
...
export const serverErrors = {
  ...
  PAYMENT_AUTH_REQUIRED: 'Please sign in before purchasing',
  PAYMENT_DISABLED: 'Payments are disabled',
  PAYMENT_METHOD_INVALID: 'Payment method is unavailable',
  PAYMENT_PLAN_NOT_FOUND: 'Plan not found or no longer for sale',
  PAYMENT_AMOUNT_INVALID: 'Invalid payment amount',
  PAYMENT_PENDING_LIMIT: 'Too many pending orders',
  ...
  PAYMENT_CANCEL_LIMIT: 'Too many order cancellations',
  PAYMENT_REFUND_UNSUPPORTED: 'Refunds are not supported for this provider',
  PAYMENT_BENEFIT_USED: 'Song cards have been used and cannot be refunded',
  PAYMENT_REFUND_FAILED: 'Refund failed',
  PAYMENT_ADMIN_REQUIRED: 'Administrator permission is required',
  PAYMENT_PROVIDER_INVALID: 'Invalid payment provider',
  PAYMENT_CONFIG_INVALID: 'Invalid payment configuration',
