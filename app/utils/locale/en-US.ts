...
export const pages = {
  ...
  auth: {
    loginForm: {
      ...
      turnstileLoading: 'Loading Cloudflare verification...',
      turnstileLoadFailed: 'Cloudflare verification not loaded',
      turnstileLoadFailedDesc: 'If this network cannot access Cloudflare verification resources, enable a proxy or switch networks and try again.',
...
export const admin = {
  ...
  operations: {
    ...
    requestIdQuick: 'Request ID quick diagnosis',
    requestIdQuickPlaceholder: 'Paste Request ID and press Enter',
    ...
    overview: {
      ...
      systemHealthDetail: 'Health score summarized from application, database, cache, and instance state.',
      sloAvailability: 'Service Health',
      sloAvailabilityDetail: 'Scores health using HTTP availability, latency, event-loop delay, and invoked external dependencies.',
      sloFormula: 'Known metrics are normalized by weight: availability 45%, P95 latency 25%, event-loop P99 15%, and dependency success 15%. Missing metrics are excluded.',
      availabilitySli: 'HTTP Availability',
      sloHealthState: 'Health',
      sloRealtimeMetrics: 'Live Metrics',
      sloScoringHint: 'Only collected values are scored. Missing metrics are never treated as healthy.',
      sloMetricScore: 'Score',
      sloScoreUnit: 'pts',
      sloNotScored: 'Not collected',
      sloCoverage: 'Coverage',
      sloHealthy: 'Healthy',
      sloAttention: 'Attention',
      sloRisk: 'At Risk',
      sloPending: 'Pending',
      sloP95Latency: 'P95 Latency',
      sloEventLoopP99: 'Event Loop P99',
      sloDependencySuccess: 'Dependency Success',
      sloRecommendations: 'Recommendations',
      sloAdviceAvailability: 'Inspect recent 5xx requests and drill into error logs by Request ID.',
      sloAdviceLatency: 'Inspect slow routes, slow queries, and pool waits, prioritizing routes above the P95 threshold.',
      sloAdviceEventLoop: 'Check synchronous blocking, intensive computation, and frequent GC that delay the event loop.',
      sloAdviceDependencies: 'Inspect failures, timeouts, and circuit breakers for invoked music sources and adjust fallback order if needed.',
      sloAdviceCoverage: 'Some metrics are not collected, so score coverage is limited. Verify the collection pipeline first.',
      sloAdviceHealthy: 'Collected metrics are stable. Continue watching peak traffic and error-budget changes.',
      sloBudget: 'SLO Error Budget',
      errorBudgetBurn: 'Error Budget Burn Rate',
      collectionStatus: 'Metrics Collection',
      deploymentMode: 'Deployment Mode and Runtime',
      deploymentModeDetail: 'Shows runtime metrics appropriate to the deployment; host resources are hidden for Serverless.',
      autoDetected: 'Auto-detected',
      detectionPending: 'Detection Pending',
      selfHostedRuntime: 'Docker / Self-hosted',
      selfHostedRuntimeDetail: 'Node RSS, event-loop lag, CPU, and container restarts',
      serverlessRuntime: 'Vercel / Netlify Serverless',
      serverlessRuntimeDetail: 'Function invocations, cold-start rate, execution P95, and concurrency',
      backupStatus: 'Backup Status',
      backupStatusDetail: 'Checks the latest backup result, artifact size, and backup storage usage.',
      referenceOnly: 'Collection Pending',
      lastBackupAt: 'Latest Backup',
      ...
      cpuStatusDetail: 'Processor load and utilization status',
      thresholdSummary: 'Warn {0}% · Critical {1}%',
      memoryStatus: 'Memory Status',
      memoryStatusDetail: 'System and process memory status',
      databaseStatus: 'Database Status',
      databaseStatusDetail: 'PostgreSQL connection and response status',
      databaseConnectionSummary: 'Conn {0} / {1} · Active {2}',
      redisStatus: 'Redis Status',
      redisStatusDetail: 'Redis configuration and connection status',
      redisClientSummary: 'Clients {0} · Hit rate {1}',
      eventLoopStatus: 'Event Loop Status',
      eventLoopStatusDetail: 'Node.js event-loop delay, active handles, and async task state',
      backgroundTaskStatus: 'Background Tasks',
      backgroundTaskStatusDetail: 'Background task execution and error status',
      sourceStatus: 'External Dependency Overview',
      sourceStatusDetail: 'Aggregated health for music sources, authentication, notifications, and other external dependencies.',
      externalDependencySummary: 'External Dependency Health',
      externalDependencySummaryDetail: 'Unified entry for music sources, JWT, and notifications; see External Dependencies for details.',
      viewDependencyDetails: 'View Dependency Details',
      neteaseSource: 'NetEase Cloud Music',
      tencentSource: 'QQ Music',
      bilibiliSource: 'Bilibili',
      miguSource: 'Migu Music',
      musicSourceDetail: 'API P95, HTTP status distribution, and circuit-breaker state',
      sourceP95: 'P95', sourceStatusCodes: 'HTTP Codes', circuitBreaker: 'Circuit Breaker',
      serviceDependencies: 'Services and Dependencies',
      serviceDependenciesDetail: 'Live availability of core application services and infrastructure dependencies.',
      collectionReportingDetail: 'Configuration and reporting state for Prometheus / Loki collection targets',
      importantEvents: 'Important Events',
      importantEventsDetail: 'Key runtime events that affect system stability and availability.',
      warningEvents: 'Alert Events',
      warningEventsDetail: 'Recent alert triggers, recoveries, and handling records.',
      recentErrorLogs: 'Recent Error Logs',
      recentErrorLogsDetail: 'Shows recent error summaries; use Request ID to continue reconstructing the request.',
      viewAllLogs: 'View All Logs',
      lastTwentyFourHours: 'Last 24 Hours',
      allAlertLevels: 'All Levels',
      allAlertStatuses: 'All Statuses',
      alertStatus: 'Alert Status',
      alertSource: 'Alert Source',
      alertContent: 'Alert Details',
      recoveryDuration: 'Duration',
      alertMetric: 'Trigger Metric',
      alertAction: 'Action Result',
      systemLogs: 'System Logs',
      systemLogsDetail: 'Prioritize service calls, exception traces, and key runtime information.',
      logArchiveSettings: 'Runtime Log Archive Settings',
      logLevel: 'Log Level',
      logScope: 'Log Scope',
      logSampleRate: 'Initial Sample Count',
      logRetentionDays: 'Retention Days',
      saveLogSettings: 'Save Settings',
      logKeyword: 'Search log content, path, or request ID',
      ...
      ruleApiAvailability: 'API Availability',
      ruleApiAvailabilityDetail: '5xx error rate above 5% for 1 minute',
      ruleDatabaseConnections: 'Database Connections Near Limit',
      ruleDatabaseConnectionsDetail: 'Active connections above 80% of the maximum for 1 minute',
      ruleSongSuccess: 'Core Song Request Success',
      ruleSongSuccessDetail: 'Song request success rate below 90% for 3 minutes',
      ruleResponseP99: 'Slow API P99',
      ruleResponseP99Detail: 'P99 response time above 3 seconds for 5 minutes',
      ruleResponseP95: 'Slow API P95',
      ruleResponseP95Detail: 'API P95 response time above 1 second for 3 minutes',
      ruleColdStarts: 'High Serverless Cold Starts',
      ruleColdStartsDetail: 'Cold-start rate above 20% for 5 minutes',
      ruleNodeMemory: 'High Node.js Process Memory',
      ruleNodeMemoryDetail: 'Node.js RSS utilization above 80% for 5 minutes',
      ...
      eventSource: 'Source',
      eventStatus: 'Status',
      servicesDetail: 'Availability of the application process and its core infrastructure dependencies.',
      runtimeDetails: 'Runtime Details',
      runtimeDetailsDetail: 'Current Node process, instance, and platform information.',
      applicationDetail: 'Nuxt service process status',
      databaseDetail: 'PostgreSQL connection and probe status',
      redisDetail: 'Redis configuration and connection status',
      ...
      recentActiveSummary: 'Users who requested, logged in, or voted',
      totalUsersSummary: 'Total system accounts',
      todayRequestsSummary: 'Song requests submitted today',
      databaseSummary: 'Connection status',
    ...
    database: {
      ...
      slowQueryCount: 'Slow Query Count', slowQueryCountDetail: 'Queries exceeding the threshold', rollbackRate: 'Transaction Rollback Rate', rollbackRateDetail: 'Rolled back transactions as a share of all transactions', cacheHitRatioDetail: 'PostgreSQL cache hit ratio', databaseSize: 'Database Size', databaseSizeDetail: 'Current database storage usage', replicaLag: 'Replication Lag', replicaLagDetail: 'Read replica synchronization delay, if configured', indexHitRatio: 'Index Hit Ratio', tableBloat: 'Table Bloat', poolWaitTime: 'Pool Wait Time', databaseGrowthRate: 'Database Growth Rate', poolerWaitQueue: 'PgBouncer Wait Queue', poolerWaitQueueDetail: 'Connections waiting in the Neon Serverless pooler', neonColdStart: 'Neon Cold-start Recovery', neonColdStartDetail: 'Time from database wake-up to accepting queries',
      sizeTrend: 'Database Size Trend', sizeTrendDetail: 'Capacity growth over time', queryTrend: 'Query Throughput Trend', queryTrendDetail: 'Observe query QPS and execution load over time.', connectionTrend: 'Connection Pool Trend', connectionTrendDetail: 'Observe active, available, and waiting connections over time.', slowQueryTrend: 'Slow Query Rate Trend', slowQueryTrendDetail: 'Identify inflection points where slow queries increase.', slowQueries: 'Slow Query Details', slowQueriesDetail: 'Slow queries grouped by fingerprint with caller route and sample request context.', queryFingerprint: 'Query Fingerprint', callerRoute: 'Caller Route', executions: 'Executions', averageDuration: 'Average Duration', maximumDuration: 'Maximum Duration', activeQueries: 'Active Queries and Blocking Chain', activeQueriesDetail: 'Inspect running queries, lock waits, and related requests during database stalls.', liveSnapshot: 'Live Snapshot', pid: 'PID', query: 'Query', duration: 'Duration', waitEvent: 'Wait Event', blockedBy: 'Blocked By', tableHealth: 'Core Table Health', tableHealthDetail: 'Confirms that required business tables are reachable; missing tables are P0 incidents.', tableScale: 'Table Size Ranking', tableScaleDetail: 'Compare table and index size and bloat to locate capacity and Vacuum risks.', rowCount: 'Rows', tableSize: 'Table Size', indexSize: 'Index Size', bloatRate: 'Bloat Rate', lastChecked: 'Last Checked', redis: 'Redis Monitoring', redisDetail: 'Cache hits, memory, connections, and command latency'
    },
    business: {
      ...
      mediaPipeline: 'Playback and Media Delivery', mediaPipelineDetail: 'Playback and download delivery after music search aggregation', musicSearchApiAvailability: 'Overall Music Search API Availability', playUrlFailures: 'Play URL Failure Rate', qualitySwitches: 'Quality Switch Requests', downloadCountAndBytes: 'Downloads / Bytes', growthAndDelivery: 'Notifications and User Growth', growthAndDeliveryDetail: 'Notification delivery and user activity growth', notificationPushes: 'Notification Pushes', notificationDeliveryRate: 'Notification Delivery Rate', dailyActiveUsers: 'DAU', newUsers: 'New Users', oauthSuccessRate: 'OAuth Success Rate', songRequestSuccessRate: 'Song Request Success Rate', songRequestSuccessRateDetail: 'End-to-end success from search and parsing through schedule insertion', scheduleSaveSuccessRate: 'Schedule Save Success Rate', scheduleSaveSuccessRateDetail: 'Success rate for admin schedule save and publish operations', songRequestQps: 'Song Request QPS', songRequestQpsDetail: 'Requests per second across the request path', scheduleOperationQps: 'Schedule Operation QPS', scheduleOperationQpsDetail: 'Drag, save, and publish operations per second', pendingQueueLength: 'Pending Queue Length', pendingQueueLengthDetail: 'Songs currently waiting for schedule processing', queueProcessingRate: 'Queue Processing Rate', queueProcessingRateDetail: 'Items completed from the pending queue per minute', queueOldestAge: 'Oldest Queue Item Age', queueBacklogGrowth: 'Queue Backlog Growth', queueHealth: 'Queue and Backlog', queueHealthDetail: 'Uses queue length, processing rate, and oldest age to detect business processing stalls.', requestRateTrend: 'Song Request QPS Trend', requestRateTrendDetail: 'Supports capacity planning and peak-period scaling decisions.', scheduleRateTrend: 'Schedule Operation QPS Trend', scheduleRateTrendDetail: 'Shows throughput and burst pressure from drag, save, and publish actions.', capacityPlanning: 'Capacity Planning Signals', capacityPlanningDetail: 'Relates business peaks to pool and Serverless concurrency headroom.', peakRequestQps: 'Peak Song Request QPS', peakScheduleQps: 'Peak Schedule QPS', dbPoolHeadroom: 'Database Pool Headroom', serverlessConcurrencyHeadroom: 'Serverless Concurrency Headroom', operationOutcomes: 'Core Operation Outcomes', operationOutcomesDetail: 'Keeps only business golden signals that affect availability and capacity decisions.', operation: 'Operation', qps: 'QPS', successRate: 'Success Rate', impact: 'Impact', backlog: 'Queue Backlog', backlogDetail: 'Sustained growth means processing is slower than incoming business volume.'
    },
    debug: {
      requestSearch: 'Diagnostic Search',
      requestSearchDetail: 'Locate problematic requests by requestId, user, route, and request characteristics.',
      allPanelsLinked: 'Linked Panels',
      ...
      serverErrors: 'Status: 5xx',
      minimumDuration: 'Minimum Duration',
      diagnose: 'Run Diagnosis',
      singleRequestTrace: 'Single-request Trace',
      singleRequestTraceDetail: 'Reconstruct request context, execution, and downstream calls from a requestId.',
      statusCode: 'Status Code',
      statusCodeDetail: 'Final HTTP response status',
      duration: 'Request Duration',
      durationDetail: 'From service entry to response completion',
      user: 'User',
      userDetail: 'User account associated with the request',
      routeDetail: 'Matched Server API route',
      occurredAt: 'Occurred At',
      occurredAtDetail: 'Time the request entered the system',
      relatedLinks: 'Related Links',
      relatedLinksDetail: 'Sentry event / full logs',
      traceWaterfall: 'Request Duration Waterfall',
      traceWaterfallDetail: 'Displays request, database, and upstream dependency spans in execution order and true duration proportions.',
      traceWaterfallMode: 'Trace / Log Synthesis',
      traceEnterRequestId: 'Enter a Request ID to view the duration distribution across the trace.',
      traceNotCollected: 'No trace or composable structured logs have been collected for this request. Check trace reporting and try again.',
      openLogCenter: 'Search in Log Center',
      requestLogChain: 'Complete Request Log Chain',
      requestLogChainDetail: 'All structured logs for the same requestId in chronological order.',
      elapsed: 'Elapsed',
      eventName: 'Event Name',
      structuredFields: 'Structured Fields',
      enterRequestId: 'Enter a requestId to display the complete trace',
      diagnosisResult: 'Diagnosis Result',
      errorAggregation: 'Error Aggregation',
      errorAggregationDetail: 'Start with frequent errors and route trends when no requestId is available.',
      topErrors: 'Top 10 Errors',
      topErrorsDetail: 'Grouped by error fingerprint with a sample requestId for drilldown.',
      errorMessage: 'Error Message',
      occurrences: 'Occurrences',
      affectedUsers: 'Affected Users',
      sampleRequestId: 'Sample Request ID',
      drilldown: 'Drill down',
      lastOccurred: 'Last Occurred',
      errorTrend: 'Error Trend',
      errorTrendDetail: 'Stacked route errors over time.',
      slowRequestDiagnosis: 'Slow Request Diagnosis',
      slowRequestDiagnosisDetail: 'Distinguish broad performance degradation from a small long tail.',
      topSlowRequests: 'Top 20 Slow Requests',
      topSlowRequestsDetail: 'Sorted by duration with user and requestId context.',
      durationDistribution: 'Duration Distribution',
      durationDistributionDetail: 'Use the histogram to identify broad slowdown or long-tail outliers.',
      userPerspective: 'User Perspective',
      userPerspectiveDetail: 'Reconstruct a user operation sequence around the reported issue.',
      userRequestTimeline: 'Single-user Request Timeline',
      userRequestTimelineDetail: 'Requests for the selected user in chronological order.',
    ...
    logCenter: {
      ...
      errorLogsDetail: 'ERROR and FATAL level logs',
      warningLogs: 'Warning Logs',
      warningLogsDetail: 'WARN level logs',
      requestTraces: 'Request Traces',
      requestTracesDetail: 'Distinct requests containing a requestId',
      structuredQuery: 'Log Search',
      structuredQueryDetail: 'Combine full-text search with requestId, user, route, level, and other structured filters.',
      fullTextSearch: 'Full-text + Structured',
      keywordPlaceholder: 'Search messages, stack traces, or structured fields',
      requestIdPlaceholder: 'Filter by exact Request ID',
      allUsers: 'All Users',
      allRoutes: 'All Routes',
      allStatusCodes: 'All Status Codes',
      query: 'Query Logs',
      logResults: 'Log Results',
      logResultsDetail: 'Matching logs in reverse chronological order with requestId links to request diagnostics.',
      logContext: 'Selected Log Context',
      logContextDetail: 'Request, instance, user, and network context associated with the selected log.',
      traceId: 'Trace ID',
      instanceId: 'Instance ID',
      sourceIp: 'Source IP',
      archiveSettings: 'Log Archive',
      archiveSettingsDetail: 'Sampling, retention, and archive capacity settings.',
      archiveSize: 'Archive Size',
      lastArchivedAt: 'Last Archived At'
    },
    dependencies: {
      ...
      neonPostgresql: 'Neon PG',
      connectionUsage: 'Connection Usage',
      cacheHitRate: 'Hit Rate',
      latencyAndErrors: 'Latency and Error Comparison',
      latencyAndErrorsDetail: 'Compare stability across NetEase, QQ Music, and Bilibili.',
      p95Latency: 'P95 Latency by Platform',
      p95LatencyDetail: 'Three platform latency series and an alert threshold.',
      ...
      upstreamErrors: '5xx / Upstream Failure',
      timeoutErrors: 'Timeout / Network',
      fallbackAndCache: 'Fallback and Cache',
      fallbackAndCacheDetail: 'Fallback and cache pressure while external services are degraded.',
      fallbackHits: 'Fallback Hits',
      fallbackHitsDetail: 'A spike usually means fallback strategies are sustaining availability.',
      providerFallbacks: 'Provider Fallbacks',
      retryAttempts: 'Upstream Retries',
      circuitBreakerOpens: 'Circuit Breaker Opens',
      cachedResponseFallbacks: 'Cached Response Fallbacks',
      searchCacheHitRate: 'Search Cache Hit Rate',
      searchCacheHitRateDetail: 'A sharp drop may rapidly increase upstream request pressure.',
    ...
    online: {
      ...
      totalUsers: 'Total Users',
      recentActiveDetail: 'Available from real-time statistics',
      todayRequestsDetail: 'Song requests submitted today',
      activeContributorsDetail: 'Users with song submissions',
      totalUsersDetail: 'Total system accounts',
      activeUserPercentage: 'Active User Share',
      activeUserPercentageDetail: 'Users who submitted songs in the selected period',
      averageSongsPerUser: 'Average Submissions per User',
      averageSongsPerUserDetail: 'Total song submissions divided by total users',
      peakHours: 'Peak Request Hours',
      peakHoursDetail: 'Top three request hours from the last seven days',
      activitySummary: 'Real-time Activity Summary',
      accountSummary: 'Account Status Summary',
      activeAccounts: 'Active Accounts',
      withdrawnAccounts: 'Withdrawn Accounts',
      graduatedAccounts: 'Graduated Accounts',
      activeRanking: 'Active Contributor Ranking',
      recentLoginUsers: 'Recently Logged-in Users',
      user: 'User',
    ...
    server: {
      ...
      runtimeEnvironmentDetail: 'Instance, operating system, and Node process runtime information.',
      database: 'Database Pool',
      healthScore: 'Server Health Score',
      healthScoreDetail: 'Summarized from runtime resources and process state; availability is (1 - 5xx / total requests) × 100%.',
      healthLevel: 'Health Level',
      alertCount: 'Alerts',
      ...
      containerRestarts: 'Container Restarts', containerRestartsDetail: 'Docker / container deployments only: restart and OOM records', restartEvents: 'Recent Restart Events', restartEventsDetail: 'Docker / container deployments only; records restart time, reason, exit code, and OOM state for log drilldown.', restartReason: 'Restart Reason', exitCode: 'Exit Code', oomKilled: 'OOMKilled',
      ...
      deployedAt: 'Deployment Time',
      cpuDetails: 'CPU Details',
      cpuDetailsDetail: 'Processor model, logical cores, and system load.',
      cpuModel: 'Processor Model',
      cpuCores: 'Logical Cores',
      loadAverage1: '1-minute Load',
      loadAverage5: '5-minute Load',
      loadAverage15: '15-minute Load',
      systemMemoryDetails: 'System Memory Details',
      systemMemoryDetailsDetail: 'Physical memory capacity and availability.',
      systemMemoryTotal: 'Total Physical Memory',
      systemMemoryUsed: 'Used Physical Memory',
      systemMemoryAvailable: 'Available Physical Memory',
      diskDetails: 'Disk Details',
      diskDetailsDetail: 'Host disk capacity and partition count.',
      diskTotal: 'Total Disk Capacity',
      diskAvailable: 'Available Disk Capacity',
      partitionCount: 'Partitions',
      nodeProcessDetails: 'Node Process Details',
      ...
      gcCount: 'GC Count',
      gcPause: 'GC Pause',
      eventLoopP99Lag: 'Event Loop P99 Lag',
      cpuTrend: 'CPU Usage Trend', cpuTrendDetail: 'View CPU usage and load inflection points over time.', memoryTrend: 'System Memory Trend', memoryTrendDetail: 'Detect stepwise growth and whether memory drops after GC.', diskIoTrend: 'Disk I/O Trend', diskIoTrendDetail: 'Correlate throughput and I/O wait with downloads or backups.', networkTrend: 'Network Ingress / Egress Trend', networkTrendDetail: 'Observe traffic peaks and link headroom over time.',
      uptime: 'System Uptime',
      memory: 'Process Memory',
      nodeVersion: 'Node Version',
      databasePool: 'Database Connections',
      uptimeDetail: 'From system status',
      memoryDetail: 'Heap memory usage',
      runtimeDetail: 'Current runtime version',
      ...
      cacheHitRatio: 'Database Cache Hit Ratio',
      memoryDetails: 'Process Memory Details',
      ...
      schemaStatusDetail: 'Expected core tables and the current user count from the database status endpoint.',
      tableName: 'Table / Metric',
      tableStatus: 'Status',
      tableValue: 'Value',
      usersTable: 'user table',
      songsTable: 'song table',
      votesTable: 'vote table',
      scheduleTable: 'schedule table',
      notificationsTable: 'notification table',
      totalUsers: 'Total users'
    },
    cache: {
      configured: 'Redis Configured',
      ready: 'Redis Connection',
      keyPrefix: 'Key Prefix',
      ttl: 'Cache TTL',
      configuredDetail: 'Whether Redis is enabled',
      readyDetail: 'Current connection state',
      prefixDetail: 'Project cache namespace',
      connectionDetail: 'Timestamp maintained by the Redis client when it becomes ready',
      errorDetail: 'Most recent Redis connection error, when available',
      ttlDetail: 'Built-in cache lifetime',
      connection: 'Cache Connection Details',
      endpoint: 'Endpoint',
      lastConnected: 'Last Connected',
      lastError: 'Last Error',
      databaseCache: 'Database Cache',
      databaseCacheTtl: 'Database Cache TTL',
      note: 'Cache Notes',
      description: 'This section covers Redis-backed short-lived state, rate limiting, and database-manager cache settings already used by the project. Hit rate and key count are not collected by a unified endpoint yet.',
      usageScope: 'Cache Usage Scope',
      shortState: 'Short-lived State',
      shortStateDetail: 'Captcha and verification workflow data',
      rateLimit: 'Request Rate Limiting',
      rateLimitDetail: 'Cross-instance request frequency controls',
      ...
      hitRatio: 'Cache Hit Ratio', hitRatioDetail: 'Share of Redis commands served from cache', memoryUsed: 'Memory Usage', memoryUsedDetail: 'Current Redis memory usage', connections: 'Connections', connectionsDetail: 'Redis client connection count', commandP99: 'Command P99 Latency', commandP99Detail: 'Tail latency of Redis commands', evictions: 'Evictions', evictionsDetail: 'Keys evicted by the memory policy', rateLimitTriggers: 'Rate-limit Triggers', rateLimitTriggersDetail: 'Requests blocked by Redis rate limiting', memoryFragmentation: 'Memory Fragmentation', memoryFragmentationDetail: 'Ratio of Redis used_memory_rss to used_memory', evictionPolicy: 'Eviction Policy', commandMetrics: 'Redis Command Metrics', commandMetricsDetail: 'Calls, latency, and errors by command', command: 'Command', calls: 'Calls', commandErrors: 'Errors'
    },
    audit: {
      unresolvedEvents: 'Unresolved Risk Events',
      unresolvedEventsDetail: 'Risk events awaiting confirmation or handling',
      criticalPending: 'Critical Pending',
      criticalPendingDetail: 'Critical events requiring immediate attention',
      newToday: 'New Risks Today',
      newTodayDetail: 'Security risks newly detected today',
      resolvedToday: 'Resolved Today',
      resolvedTodayDetail: 'Risk events confirmed or closed today',
      pendingRiskDistribution: 'Pending Risk Distribution',
      pendingRiskDistributionDetail: 'Open security events grouped by risk level.',
      riskScoreFormula: 'The risk score weights failed logins, rate-limit hits, blacklist matches, and invalid-token signals. Reaching a threshold requires review or IP blocking.',
      pending: 'Pending',
      highRiskIps: 'High-risk IPs',
      highRiskIpsDetail: 'Source addresses repeatedly triggering risk events in a short period.',
      recentHighRiskEvents: 'Recent High-risk Events',
      recentHighRiskEventsDetail: 'Critical and high-risk events prioritized for review.',
      highRisk: 'High Risk',
      eventList: 'Risk Event List',
      eventListDetail: 'Detected attacks, abnormal access, and other high-risk behavior.',
      keywordFilter: 'Search ID, title, user, IP, or path',
      allRiskLevels: 'All Risk Levels',
      allHandlingStatuses: 'All Handling Statuses',
      query: 'Search',
      eventId: 'Event ID',
    ...
    analytics: {
      totalUsers: 'Total Users',
      totalUsersDetail: 'Total registered users in the system',
      totalSongsDetail: 'Total song submissions in the system',
      totalSchedules: 'Total Schedules',
      totalSchedulesDetail: 'Number of playback schedules created',
      weeklyRequests: 'Requests This Week',
      weeklyRequestsDetail: 'Song requests created during the current week',
      activeContributors: 'Contributing Users',
      activeContributorsDetail: 'Users who submitted songs in the selected period',
      activeUserPercentage: 'Participation Rate',
      activeUserPercentageDetail: 'Contributing users as a share of all users',
      averageSongsPerUser: 'Average Submissions per User',
      averageSongsPerUserDetail: 'Total submissions divided by total users',
      engagementDistribution: 'User Engagement Distribution',
      engagementDistributionDetail: 'Contributors, recently active users, and users without submissions.',
      recentActiveUsers: 'Active in the Last 7 Days',
      inactiveUsers: 'Users without Submissions',
      requestTrend: 'Request Trend',
      requestTrendDetail: 'Daily song requests over the last 30 days.',
      lastThirtyDays: 'Last 30 Days',
      semesterComparison: 'Semester Comparison',
      semesterComparisonDetail: 'Songs, schedules, and voted songs across semesters.',
      semester: 'Semester',
      totalSongs: 'Songs',
      scheduledSongs: 'Schedules',
      votedSongs: 'Voted Songs',
      semesterStatus: 'Status',
      engagementSummary: 'Engagement Summary',
      engagementSummaryDetail: 'Core metrics from the user engagement statistics endpoint.',
      recentActivePercentage: 'Recent Active User Share',
      topSongs: 'Top Songs',
      topSongsDetail: 'Popular songs ranked by votes or replay requests.',
      rank: 'Rank',
      song: 'Song',
      artist: 'Artist',
      requester: 'Requester',
      votesOrReplays: 'Votes / Replays',
      peakHours: 'Peak Request Hours',
      peakHoursDetail: 'The three busiest request hours over the last 7 days.',
      firstPeak: 'Top Peak',
      secondPeak: 'Second Peak',
      thirdPeak: 'Third Peak'
    },
    filters: {
      allScopes: 'All Areas',
      server: 'Server',
    ...
    references: {
      ...
      security: [
        { metric: 'Security Signal Rate', threshold: 'Unexpected surge against the last 24-hour baseline', collection: 'Application instrumentation / Loki', description: 'Uses failed-login, rate-limit, and blacklist rates to identify an ongoing attack.' },
        { metric: 'Risk Score', threshold: 'Critical >= 80, high >= 60', collection: 'Risk rules engine', description: 'Computed from weighted security signals and reviewed with the IP behavior timeline before taking action.' },
