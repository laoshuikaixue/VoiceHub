...
export const admin = {
  ...
  operations: {
    ...
    overview: {
      ...
      coroutineStatusDetail: 'Asynchronous coroutine runtime status',
      backgroundTaskStatus: 'Background Tasks',
      backgroundTaskStatusDetail: 'Background task execution and error status',
      sourceStatus: 'Music Source Checks',
      sourceStatusDetail: 'Availability checks for connected music search sources.',
      sourceCheckDetail: 'Music source access and search probe',
      ...
      telemetryDetail: 'Instance telemetry configuration and reporting state',
