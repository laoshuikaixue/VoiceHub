...
export const admin = {
  ...
  operations: {
    ...
    server: {
      ...
      healthScoreDetail: 'Summarized from CPU, memory, disk, network, and process state.',
      healthLevel: 'Health Level',
      alertCount: 'Alerts',
      ...
      containerRestarts: 'Container Restarts', containerRestartsDetail: 'Container restarts and OOM records', restartEvents: 'Recent Restart Events', restartEventsDetail: 'Records restart time, reason, exit code, and OOM state for log drilldown.', restartReason: 'Restart Reason', exitCode: 'Exit Code', oomKilled: 'OOMKilled',
