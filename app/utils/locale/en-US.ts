...
export const pages = {
  ...
  ui: {
    ...
    lyricsModal: {
      ...
      lyricSourceQm: 'QQ Music',
      lyricSourceOfficial: 'NetEase',
      lyricSourceTtml: 'AMLL TTML',
      lyricSourceActualOfficial: 'Official',
      lyricSourceActualQm: 'QQ',
      lyricSourceActualAmll: 'AMLL',
      lyricSourceActualUpgrade: 'Upgrade',
      lyricSourceActualMeting: 'Meting',
      playMode: {
        loopOne: 'Repeat One',
