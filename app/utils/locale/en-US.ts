...
export const pages = {
  ...
  ui: {
    ...
    songComments: {
      ...
      qqLoginRequiredToLike: 'Please sign in to QQ Music before liking comments',
...
export const serverErrors = {
  ...
  QQ_COMMENT_LIKE_FAILED: 'Failed to update the QQ Music comment like. Please try again later.',
