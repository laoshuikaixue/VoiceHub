...
export const admin = {
  ...
  scheduleManager: {
    ...
    refreshCandidateDurations: 'Refresh Candidate Durations',
  ...
  requestTimeManager: {
    ...
    restrictionPanelHint: 'Scope applies to both same-song and same-artist checks',
    restrictionSaveSuccess: 'Restriction settings saved',
    restrictionSaveFailed: 'Failed to save restriction settings',
    restrictionAtLeastOne: 'At least one of same-song or same-artist window must be set',
    stats: {
