...
export const admin = {
  ...
  notificationSender: {
    ...
    history: {
      ...
      editImportant: 'Important Full-screen Notification',
      editImportantDescription: 'Existing read status is preserved; unread important notices still appear full-screen',
