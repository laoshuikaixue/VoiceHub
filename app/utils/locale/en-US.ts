export const siteConfig = {
  ...
  songQuotaEnabled: 'Enable Request Quota',
  songQuotaEnabledDesc: 'Use unified periodic and permanent request quotas',
  songQuotaPeriodType: 'Refresh Period',
  songQuotaPeriodAmount: 'Quota per Period',
  songQuotaDaily: 'Daily',
  songQuotaWeekly: 'Weekly',
  songQuotaMonthly: 'Monthly',
  adminSongQuotaExempt: 'Admin Exemption',
  adminSongQuotaExemptDesc: 'Admin requests do not consume quota',
  blockOnSongQuotaInsufficient: 'Block Without Quota',
  blockOnSongQuotaInsufficientDesc: 'Reject new requests when the user has no available quota',
...
export const pages = {
  ...
  songs: {
    ...
    scheduleList: {
      ...
      previousDate: 'Previous schedule date',
      nextDate: 'Next schedule date',
    ...
    requestForm: {
      ...
      notifications: {
        ...
        quotaInsufficient: 'Insufficient request quota. You cannot submit right now'
      },
      ...
      redeemCardTitle: 'Redeem Legacy Coupon',
      redeemCardPlaceholder: 'Enter card code',
      redeemCardHint: 'Legacy coupons can be redeemed for permanent quota',
      redeemCardConfirm: 'Redeem',
      redeemCardSuccess: 'Redeemed successfully, +1 permanent quota',
      redeemCardEmpty: 'Please enter a card code',
      redemptionLoading: 'Redeeming...'
    },
    songQuotaDisplay: {
      adminUnlimited: 'Admin - No Limit',
...
export const admin = {
  ...
  overview: {
    ...
    refreshActivities: 'Refresh recent activities',
    loading: 'Loading...',
  ...
  requestTimeManager: {
    ...
    cancel: 'Cancel',
    delete: 'Delete request time slot',
    saving: 'Saving...',
    saveSettings: 'Save Settings',
  ...
  songQuotaManager: {
    ...
    desc: 'View and manage user song request quota accounts',
    refresh: 'Refresh',
    searchPlaceholder: 'Search by name or username',
    selectUser: 'Select User',
    selectUserPlaceholder: 'Select a user from the list',
    accountList: 'Quota Accounts',
    loading: 'Loading...',
    userId: 'User ID',
    userName: 'User',
    periodic: 'Periodic',
    ...
    actions: 'Actions',
    detail: 'Detail',
    emptyAccounts: 'No quota accounts found',
    totalAccounts: 'accounts',
    itemName: 'records',
    accountDetail: 'Account Detail',
    clearSelection: 'Clear',
    gradeClass: 'Grade/Class',
    periodicBalance: 'Periodic Balance',
    permanentBalance: 'Permanent Balance',
    totalBalance: 'Total Balance',
    adjustQuota: 'Adjust Quota',
    amount: 'Amount',
    requestIdPlaceholder: 'Idempotency Request ID (required)',
    publicDescPlaceholder: 'Public description (optional)',
    internalNotePlaceholder: 'Internal note (optional)',
    saving: 'Submitting...',
    submitAdjust: 'Submit Adjustment',
    selectAccountHint: 'Select a user from the list to view details',
    quickTipsTitle: 'Quick Tips',
    quickTips: [
      'Quota adjustments are irreversible. Confirm before submitting.',
      'The request ID ensures idempotency. Use a different ID for each adjustment.',
      'Decrement cannot exceed the current permanent balance.',
      'The SET operation sets permanent balance to the specified value. Only executed when different from the current value.'
    ],
    transactionHistory: 'Transaction History',
    transactionDesc: 'View all quota transaction records',
    refreshLogs: 'Refresh',
    transactionUser: 'User ID',
    transactionUserPlaceholder: 'Filter by user ID',
    ...
    loadingLogs: 'Loading transactions...',
    noTransactions: 'No transactions found',
    txItemName: 'transactions',
    allTypes: 'All Types',
    ...
    sourceLabels: {
      periodGrant: 'Period Grant',
      periodExpired: 'Period Expired',
      adminAdjust: 'Admin Adjust',
      adminBulkAdjust: 'Bulk Adjust',
      openApiAdjust: 'Open API',
      songRequest: 'Song Request',
      withdrawReturn: 'Withdraw Return',
      withdrawExpired: 'Withdraw Expired',
      legacyCardConvert: 'Legacy Convert'
    },
    stats: {
      totalAccounts: 'Total Accounts',
      withQuota: 'With Quota',
      periodicTotal: 'Periodic Total',
    ...
    messages: {
      fetchFailed: 'Failed to fetch quota accounts',
      fetchLogsFailed: 'Failed to fetch quota transactions',
      adjustSuccess: 'Quota adjustment successful',
      adjustFailed: 'Quota adjustment failed'
    }
  },
  cardCodesManager: {
    title: 'Card Code Management',
    desc: 'Manage card code creation, filtering, redemption, import/export, and notes',
    refresh: 'Refresh',
    exporting: 'Exporting...',
    searchPlaceholder: 'Search card codes or notes',
    status: 'Status',
    allStatus: 'All Status',
    clearFilters: 'Clear Filters',
    selectedItems: (count: number) => `${count} selected`,
    ...
    unknown: 'Unknown',
    empty: 'No matching card codes found',
    itemName: 'card codes',
    createTitle: 'Bulk Create / Import',
    createDesc: 'Paste separated codes manually or generate card codes automatically',
    manualImport: 'Manual Import',
    autoGenerate: 'Auto Generate',
    manualPlaceholder: 'Enter one card code, or separate multiple codes with commas, newlines, or spaces',
    generateCount: 'Count',
    prefix: 'Prefix',
    ...
    createCardCode: 'Create Card Codes',
    fillDemo: 'Fill Demo',
    demoNote: 'Demo card codes',
    lastGeneratedTitle: (count: number) => `${count} card codes generated this time`,
    lastGeneratedDesc: 'Only the latest auto-generated result is kept so you can copy it before distribution.',
    copyAll: 'Copy All',
    quickTipsTitle: 'Quick Tips',
    quickTips: [
      'Filter by status and keyword; search covers card codes and notes.',
      'Switch single or bulk statuses to lock, redeem, or invalidate codes.',
      'Edit notes in place to record recipients, batches, or source details.',
      'Export generates a complete CSV from current filters; selected codes are exported first.'
    ],
    redeemLogsTitle: 'Redeem Logs',
    redeemLogsDesc: 'Track which account redeemed each card code, when, from where, and related songs',
    refreshLogs: 'Refresh Logs',
    keyword: 'Keyword',
    logSearchPlaceholder: 'Card code / account / song / source',
    source: 'Source',
    allSources: 'All Sources',
    redeemer: 'Redeemer',
    ...
    messages: {
      fetchFailed: 'Failed to load card codes',
      fetchLogsFailed: 'Failed to load card code redeem logs',
      copied: 'Card code copied',
      copyFailed: 'Copy failed. Please copy manually',
      exportFailed: 'Failed to export card codes',
      exportSelectedSuccess: 'Selected card codes exported',
      exportFilteredSuccess: 'Filtered results exported',
      statusUpdated: 'Status updated',
      updateStatusFailed: 'Failed to update card code status',
      noteSaved: 'Note saved',
      saveNoteFailed: 'Failed to save note',
      inputRequired: 'Please enter card codes first',
      createSuccess: (count: number) => `Created ${count} card codes`,
      createDone: (inserted: number, skipped: number) => `Created ${inserted}; skipped ${skipped} duplicates`,
      createFailed: 'Failed to create card codes',
      noGeneratedToCopy: 'No generated card codes to copy',
      copiedGenerated: (count: number) => `Copied ${count} card codes`
    },
    stats: {
      total: 'Total',
      all: 'All',
  ...
  apiKeys: {
    ...
    permissionOptions: {
      ...
      songQuotasRead: { label: 'Quota Read', description: 'View song quota for a specified user' },
      songQuotasAdjust: { label: 'Quota Adjust', description: 'Idempotently adjust permanent quota for a specified user' },
      songQuotaTransactionsRead: { label: 'Quota Txn Read', description: 'View quota transactions for a specified user' },
...
export const serverErrors = {
  SONG_QUOTA_DISABLED: 'Song request quota is disabled',
  SONG_QUOTA_INSUFFICIENT: 'Insufficient song request quota',
  SONG_QUOTA_ACCOUNT_INVALID: 'The song request quota account is invalid',
  SONG_QUOTA_PERIOD_CONFIG_INVALID: 'The song request quota period configuration is invalid',
  SONG_QUOTA_NEGATIVE_BALANCE: 'The adjusted quota cannot be negative',
  SONG_QUOTA_ALREADY_RETURNED: 'The quota for this song has already been returned',
  SONG_QUOTA_INVALID_ADJUSTMENT: 'The quota adjustment must be a non-zero integer',
  SONG_QUOTA_IDEMPOTENCY_CONFLICT: 'The idempotency key was already used for a different quota adjustment',
  CARD_CODE_NOT_FOUND: 'Card code not found',
  CARD_CODE_UNAVAILABLE: 'Card code cannot be redeemed',
  CARD_CODE_ALREADY_REDEEMED: 'Card code has already been redeemed',
  CARD_CODE_RATE_LIMITED: 'Too many redemption attempts, please try again later',
  ...
  SONG_REQUEST_IDEMPOTENCY_CONFLICT: 'The request ID was already used for a different song request',
