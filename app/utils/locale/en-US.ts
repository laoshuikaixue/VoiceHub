...
export const admin = {
  ...
  operations: {
    ...
    audit: {
      statusLogs: 'Account Status Change Logs',
      statusChanges: 'Status Changes',
      passwordEvents: 'Password Security Events',
      apiRequests: 'API Access Logs',
      apiSuccessRequests: 'Successful API Requests',
      apiErrorRequests: 'Failed API Requests',
      apiAverageResponse: 'Average API Response',
      apiMinResponse: 'Minimum API Response',
      apiMaxResponse: 'Maximum API Response',
      apiLogSummary: 'API Log Statistics',
      apiLogSummaryDetail: 'Request counts and response-time metrics exposed by the API log service.',
      apiAccessLogs: 'Recent API Access Logs',
      apiAccessLogsDetail: 'Request records include endpoint, method, status, latency, and client address.',
      statusChangesDetail: 'User enable and disable records',
      passwordEventsDetail: 'Password change and reset records',
      apiRequestsDetail: 'API key request records',
      apiSuccessRequestsDetail: 'Responses with a 2xx status code',
      apiErrorRequestsDetail: 'Responses with a 4xx or 5xx status code',
      apiAverageResponseDetail: 'Average response time in milliseconds',
      apiMinResponseDetail: 'Minimum response time in milliseconds',
      apiMaxResponseDetail: 'Maximum response time in milliseconds',
      endpoint: 'Endpoint',
      method: 'Method',
      statusCode: 'Status Code',
      responseTime: 'Response Time',
      account: 'Account',
      statusTransition: 'Status Change',
      operator: 'Operator',
      reason: 'Reason',
      ip: 'IP Address',
      accountStatus: 'Account Status',
      sources: 'Available Audit Sources',
      loginRecords: 'Recent Login Records',
      userStatus: 'User Status Changes',
      passwordSecurity: 'Password Security Logs',
      userLogin: 'User Login Information',
      apiKeyAccess: 'API Key Access Logs'
    },
    filters: {
      allScopes: 'All Areas',
      server: 'Server',
