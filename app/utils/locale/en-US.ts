...
export const admin = {
  ...
  operations: {
    ...
    overview: {
      ...
      sloAvailabilityDetail: 'Calculates the availability SLI from 5xx request share and compares it with the monthly SLO error budget.',
      sloFormula: 'Availability SLI = (1 - 5xx requests / total requests) × 100%; the error budget follows the monthly SLO target.',
      availabilitySli: 'Availability SLI',
