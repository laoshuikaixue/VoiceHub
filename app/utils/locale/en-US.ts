...
export const admin = {
  ...
  oauthConfig: {
    ...
    qqTitle: 'QQ OAuth',
    qqClientId: 'QQ Client ID (App ID)',
    qqClientSecret: 'QQ Client Secret (App Key)',
    qqClientIdPlaceholder: 'Enter QQ App ID',
    qqClientSecretPlaceholder: 'Enter QQ App Key',
    qqDocLabel: 'View QQ Connect documentation',
    nativeQQConflictHint: 'Aggregate QQ login is currently enabled. After saving, native QQ login takes precedence and the aggregate QQ option will be ignored automatically.',
    aggregateQQConflictHint: 'Native QQ login is enabled. The aggregate QQ option will be ignored automatically to avoid duplicate login entries and identity records for the same QQ user.',
