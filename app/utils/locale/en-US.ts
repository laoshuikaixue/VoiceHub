export const siteConfig = {
  ...
  esaCaptchaSceneIdPlaceholder: 'Enter the Scene ID of the rule in the CAPTCHA rule list',
  esaCaptchaRegion: 'Region',
  esaCaptchaRegionCn: 'Chinese mainland',
  esaCaptchaRegionSgp: 'Singapore',
  esaCaptchaDesc: 'When enabled, all users must pass the ESA AI CAPTCHA verification on each login. Add a CAPTCHA rule in the ESA console first and register this site login endpoint as the API to be verified. The CAPTCHA type (traceless / click-and-pass / slider / puzzle) is decided by the rule the Scene ID belongs to and is delivered by ESA when the login page initializes; after switching rules or changing the type, update the Scene ID and reload the login page.',
...
export const serverErrors = {
  ...
  SETTINGS_ESA_CAPTCHA_CREDENTIALS_MISSING: 'Configure the Identity and Scene ID before switching to Alibaba Cloud ESA AI CAPTCHA',
