<template>
  <div class="slide-container" v-if="data.firstSong">
    ...
    <Transition name="entry" appear>
      <div class="content" v-show="active">
        ...
        <p class="text-intro">
          这一年，你点的<span class="highlight">第一首歌</span>是
        </p>

        <div class="vinyl-container">
          <div class="vinyl-record">
             <img v-if="data.firstSong.cover" :src="data.firstSong.cover" alt="Cover" class="cover-img" />
             <div v-else class="placeholder-icon">
                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
             </div>
...
@media (max-width: 768px) {
  ...
  .vinyl-container { max-width: 280px; }
}
</style>
