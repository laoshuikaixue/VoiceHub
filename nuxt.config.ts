  ...
  unocss: {
    ...
    theme: {
      colors: {
        ...
        // --purple → 协作/装饰色（collab = 协作邀请、年度回顾）
        'bg-purple-500': 'bg-color-collab',
        'bg-purple-50': 'bg-color-collab-light',
        'bg-purple-900': 'bg-color-collab-hover',
        'text-purple-500': 'text-color-collab',
        'text-purple-600': 'text-color-collab-hover',
        'text-purple-700': 'text-color-collab-hover',
        'text-purple-300': 'text-color-collab-light',
        'text-purple-200': 'text-color-collab-light',
        'ring-purple-500': 'ring-color-collab',
        // --pink → 装饰色（年度回顾）
        'bg-pink-500': 'bg-color-pink',
        'text-pink-500': 'text-color-pink',
        'border-pink-500': 'border-color-pink',
        'fill-pink-500': 'fill-color-pink',
        // --gray → 文字灰度
