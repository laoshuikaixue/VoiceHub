...
const siteDescription =
  ...
  '校园广播站点歌系统 - 让你的声音被听见'
const siteLogo = customSeoConfig.logo || process.env.NUXT_PUBLIC_SITE_LOGO || '/themes/dark/logo.svg'
...
export default defineNuxtConfig({
  ...
  unocss: {
    ...
    theme: {
      colors: {
        ...
        'bg-blue-800': 'bg-primary-hover',
        'bg-blue-900': 'bg-primary',
        'text-blue-500': 'text-primary',
        'text-blue-400': 'text-primary',
        'text-blue-300': 'text-primary-light',
        'text-blue-700': 'text-primary-hover',
        'text-blue-800': 'text-primary-hover',
        'border-blue-500': 'border-primary',
        'border-blue-4': 'border-primary',
        'border-blue-2': 'border-primary-light',
        ...
        // --purple → 装饰色（创意/品牌）
        'bg-purple-500': 'bg-color-brand-purple',
        'bg-purple-50': 'bg-color-brand-purple-light',
        'bg-purple-900': 'bg-color-brand-purple-hover',
        'text-purple-500': 'text-color-brand-purple',
        'text-purple-600': 'text-color-brand-purple-hover',
        'text-purple-700': 'text-color-brand-purple-hover',
        'text-purple-300': 'text-color-brand-purple-light',
        'text-purple-200': 'text-color-brand-purple-light',
        'ring-purple-500': 'ring-color-brand-purple',
        // --pink → 装饰色（创意）
        'bg-pink-500': 'bg-color-brand-pink',
        'text-pink-500': 'text-color-brand-pink',
        'border-pink-500': 'border-color-brand-pink',
        'fill-pink-500': 'fill-color-brand-pink',
        // --gray → 文字灰度
        'bg-gray-50': 'bg-panel-bg-subtle',
        'bg-gray-500': 'bg-text-tertiary',
        'bg-gray-600': 'bg-text-tertiary',
        'bg-gray-700': 'bg-text-secondary',
        'bg-gray-800': 'bg-text-primary',
        'bg-gray-900': 'bg-text-primary',
        ...
        'border-gray-200': 'border-text-tertiary',
        'border-gray-700': 'border-text-secondary',
        // --slate → 文字灰度
        'border-slate-500': 'border-text-tertiary',
        // === 装饰性填充 ===
        ...
        'brand-blue-light-hover': 'var(--color-brand-blue-light-hover)',
        'brand-blue-glow': 'var(--color-brand-blue-glow)',
        ...
        'brand-green-glow': 'var(--color-brand-green-glow)',
        ...
        'brand-yellow-glow': 'var(--color-brand-yellow-glow)',
        'brand-orange': 'var(--color-brand-orange)',
        'brand-orange-light': 'var(--color-brand-orange-light)',
        'brand-orange-hover': 'var(--color-brand-orange-hover)',
        'brand-orange-glow': 'var(--color-brand-orange-glow)',
        'brand-purple': 'var(--color-brand-purple)',
        'brand-purple-hover': 'var(--color-brand-purple-hover)',
        'brand-purple-light': 'var(--color-brand-purple-light)',
        'brand-purple-lighter': 'var(--color-brand-purple-lighter)',
        'brand-purple-glow': 'var(--color-brand-purple-glow)',
        ...
        'brand-indigo-hover': 'var(--color-brand-indigo-hover)',
  ...
  pwa: {
    ...
    manifest: {
      ...
      icons: [
        {
          src: '/themes/dark/logo.png',
          sizes: '128x128',
          type: 'image/png',
          purpose: 'any'
        },
        {
          src: '/themes/dark/logo-144.png',
          sizes: '144x144',
          type: 'image/png',
          purpose: 'any'
        }
